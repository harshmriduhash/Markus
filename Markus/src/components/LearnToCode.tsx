  ...
  const skills = [
    {
      title: "HTML",
      description:
        "Structure the content of web pages using Hypertext Markup Language",
    ...
    },
    {
      title: "CSS",
      description:
        "Style, animate and design your web pages using Cascading Style Sheets.",
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
          {skills.map((skill, index) => (
            ...
            >
              {index < 10 && (
                <div className="absolute top-4 right-4 text-orange-500 font-bold">
                  FREE
                </div>
              )}
              {index >= 10 && (
                <div className="absolute top-4 right-4 text-purple-500 font-bold">
                  PRO
                </div>
              )}
