...
const CodePreview: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<"code" | "preview" | "progress">(
    "progress"
  );
  ...
  const downloadProject = async () => {
    ...
    const files = {
      "index.html":
        projectFiles.find((file) => file.name === "index.html")?.content ||
        generatedCode,
      "styles.css":
        projectFiles.find((file) => file.name === "styles.css")?.content || "",
      "script.js":
        projectFiles.find((file) => file.name === "script.js")?.content || "",
    };
      ...
      >
        <div className="text-center">
          ...
          <p className="text-gray-400 max-w-md">
            Select an AI model, enter your API key, and describe the web app you
            want to build.
          </p>
        </div>
      </motion.div>
    ...
    >
      ...
      {activeTab === "progress" && (
        <div className="flex-1 flex flex-col">
          ...
          <div
            className="flex-1 overflow-auto rounded-lg border border-dark-700 bg-dark-800 p-4"
            ...
            generationSteps.length === 0 ? (
              <div className="h-full flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-gray-400 max-w-md">
                    Start generating code to see the progress and steps taken by
                    the AI.
                  </p>
                </div>
              </div>
                  ...
                  >
                    <div className="flex items-start gap-3">
                      {step.completed ? (
                        ...
                        <Circle
                          size={18}
                          className="text-primary-500 animate-pulse mt-1 shrink-0"
                        />
                      )}
                        ...
                        {step.files && step.files.length > 0 && (
                          <div className="mt-3 space-y-3">
                            {step.files.map((file) => (
                              <div
                                key={file.path}
                                className="bg-dark-900 rounded-md overflow-hidden"
                              >
