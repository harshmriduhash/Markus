...
export const AI_MODELS: AIModel[] = [
  {
    ...
    name: "GPT-4",
    description:
      "Advanced reasoning, complex instructions, and creative content generation",
  ...
  },
  {
    ...
    name: "Claude 3",
    description:
      "Excellent at following nuanced instructions with thoughtful, safe outputs",
  ...
  },
  {
    ...
    name: "Gemini",
    description:
      "Multimodal capabilities with strong reasoning and coding abilities",
